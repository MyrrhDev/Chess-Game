    ...
    public static void main(String[] args) {
        ...
        while(driverIsRunning) {
            ...
            switch(op) {
                /*
                    Opciones:
                    1. Alta objeto Caballo, situado en el tablero
                ...
                case 1:
                    ...
                    while(!inputOK) {
                        ...
                        if(verificarEntrada(tmp)) {
                            inputOK = true;
                            Caballo c = iniPieza(esNegraInput, tmp);
                ...
                case 3:
                    ...
                    if(Character.isUpperCase(estadoTablero[Integer.parseInt(aux[0])][Integer.parseInt(aux[1])])) { //pieza blanca
                        for(int i = 0; i < PiezasBlancas.size(); ++i) {
                            if(PiezasBlancas.get(i).getTipo() == 'N' && PiezasBlancas.get(i).getPosX() == Integer.parseInt(aux[0]) && PiezasBlancas.get(i).getPosY() == Integer.parseInt(aux[1])) test = PiezasBlancas.get(i);
                        }
                    }
                    else { //Pieza negra
                        for(int i = 0; i < PiezasNegras.size(); ++i) {
                            if(PiezasNegras.get(i).getTipo() == 'n' && PiezasNegras.get(i).getPosX() == Integer.parseInt(aux[0]) && PiezasNegras.get(i).getPosY() == Integer.parseInt(aux[1])) test = PiezasNegras.get(i);
                        }
                    }
                ...
                case 4:
                    ...
                    if(Character.isUpperCase(estadoTablero[posX][posY])) { //pieza blanca
                        for(int i = 0; i < PiezasBlancas.size(); ++i) {
                            if(PiezasBlancas.get(i).getTipo() == 'N' && PiezasBlancas.get(i).getPosX() == posX && PiezasBlancas.get(i).getPosY() == posY) test2 = PiezasBlancas.get(i);
                        }
                    }
                    else { //Pieza negra
                        for(int i = 0; i < PiezasNegras.size(); ++i) {
                            if(PiezasNegras.get(i).getTipo() == 'n' && PiezasNegras.get(i).getPosX() == posX && PiezasNegras.get(i).getPosY() == posY) test2 = PiezasNegras.get(i);
                        }
                    }
