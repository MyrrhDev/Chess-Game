...
public class TableroTest {
    ...
    public void FENToTablero() {
        ...
        assertNotEquals('3', tablero.tablero[0][2]);
    ...
    public void ejecutarMovimiento() {
        ...
        assertNotEquals('R', tablero.tablero[1][5]);
    ...
    public void getAttackPlayer() {
        ...
        assertNotEquals(j2, tablero.getAttackPlayer(true));
    ...
    public void esSuTurno() {
        ...
        Jugador j1 = tablero.getJugador1();
        Jugador j2 = tablero.getJugador2();
        assertNotEquals(j1, tablero.esSuTurno());
    ...
    public void miOponenteEs() {
        ...
        assertNotEquals(j2, tablero.miOponenteEs(jugador2));
